...
#include "bias_Conv_0_biasebkl.h"

namespace ap_rtl {

struct bias : public sc_module {
    ...
    bias_Conv_0_biasebkl* Conv_0_biases_V_0_U;
    ...
    sc_signal< sc_lv<2> > Conv_0_biases_V_0_address0;
    sc_signal< sc_logic > Conv_0_biases_V_0_ce0;
    sc_signal< sc_lv<24> > Conv_0_biases_V_0_q0;
    ...
    sc_signal< sc_lv<16> > tmp_V_754_reg_235;
    sc_signal< sc_lv<24> > p_Val2_127_reg_240;
    sc_signal< sc_lv<1> > tmp_402_reg_245;
    sc_signal< sc_lv<1> > tmp_402_reg_245_pp0_iter2_reg;
    sc_signal< sc_lv<16> > p_Val2_129_reg_250;
    ...
    sc_signal< sc_lv<24> > tmp_402_fu_182_p1;
    ...
    void thread_Conv_0_biases_V_0_address0();
    void thread_Conv_0_biases_V_0_ce0();
