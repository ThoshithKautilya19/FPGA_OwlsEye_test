...
#include "bias513_Conv_0_bibll.h"

namespace ap_rtl {

struct bias513 : public sc_module {
    ...
    // Module declarations
    bias513(sc_module_name name);
    SC_HAS_PROCESS(bias513);

    ~bias513();

    sc_trace_file* mVcdFile;

    bias513_Conv_0_bibll* Conv_0_biases_V_1_U;
    ...
    sc_signal< sc_lv<2> > Conv_0_biases_V_1_address0;
    sc_signal< sc_logic > Conv_0_biases_V_1_ce0;
    sc_signal< sc_lv<24> > Conv_0_biases_V_1_q0;
    ...
    sc_signal< sc_lv<16> > tmp_V_751_reg_235;
    sc_signal< sc_lv<24> > p_Val2_115_reg_240;
    sc_signal< sc_lv<1> > tmp_399_reg_245;
    sc_signal< sc_lv<1> > tmp_399_reg_245_pp0_iter2_reg;
    sc_signal< sc_lv<16> > p_Val2_117_reg_250;
    ...
    sc_signal< sc_lv<24> > tmp_399_fu_182_p1;
    ...
    void thread_Conv_0_biases_V_1_address0();
    void thread_Conv_0_biases_V_1_ce0();
