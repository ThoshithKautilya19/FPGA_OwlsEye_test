...
// ==============================================================
#ifndef __fpgaconvnet_ip_shibs__HH__
#define __fpgaconvnet_ip_shibs__HH__
#include "ACMP_shl.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_shibs) {
    ...
    SC_CTOR(fpgaconvnet_ip_shibs):  ACMP_shl_U ("ACMP_shl_U") {
        ACMP_shl_U.clk(clk);
