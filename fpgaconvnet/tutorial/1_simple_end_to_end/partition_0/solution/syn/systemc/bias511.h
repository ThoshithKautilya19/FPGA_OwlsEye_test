...
#include "bias511_Conv_0_bibnm.h"

namespace ap_rtl {

struct bias511 : public sc_module {
    ...
    // Module declarations
    bias511(sc_module_name name);
    SC_HAS_PROCESS(bias511);

    ~bias511();

    sc_trace_file* mVcdFile;

    bias511_Conv_0_bibnm* Conv_0_biases_V_3_U;
    ...
    sc_signal< sc_lv<2> > Conv_0_biases_V_3_address0;
    sc_signal< sc_logic > Conv_0_biases_V_3_ce0;
    sc_signal< sc_lv<24> > Conv_0_biases_V_3_q0;
    ...
    sc_signal< sc_lv<16> > tmp_V_753_reg_235;
    sc_signal< sc_lv<24> > p_Val2_123_reg_240;
    sc_signal< sc_lv<1> > tmp_401_reg_245;
    sc_signal< sc_lv<1> > tmp_401_reg_245_pp0_iter2_reg;
    sc_signal< sc_lv<16> > p_Val2_125_reg_250;
    ...
    sc_signal< sc_lv<24> > tmp_401_fu_182_p1;
    ...
    void thread_Conv_0_biases_V_3_address0();
    void thread_Conv_0_biases_V_3_ce0();
