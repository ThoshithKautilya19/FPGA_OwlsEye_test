...
// ==============================================================
#ifndef __fpgaconvnet_ip_dadEe__HH__
#define __fpgaconvnet_ip_dadEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_dadEe) {
    ...
    SC_CTOR(fpgaconvnet_ip_dadEe):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
