...
// ==============================================================
#ifndef __fpgaconvnet_ip_muZio__HH__
#define __fpgaconvnet_ip_muZio__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_muZio) {
    ...
    SC_CTOR(fpgaconvnet_ip_muZio):  ACMP_mul_us_U ("ACMP_mul_us_U") {
