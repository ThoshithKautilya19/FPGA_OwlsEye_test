...
// ==============================================================
#ifndef __fpgaconvnet_ip_ls9j0__HH__
#define __fpgaconvnet_ip_ls9j0__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_ls9j0) {
    ...
    SC_CTOR(fpgaconvnet_ip_ls9j0):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
