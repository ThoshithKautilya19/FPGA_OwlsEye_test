...
// ==============================================================
#ifndef __fpgaconvnet_ip_lshbi__HH__
#define __fpgaconvnet_ip_lshbi__HH__
#include "ACMP_lshr.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_lshbi) {
    ...
    SC_CTOR(fpgaconvnet_ip_lshbi):  ACMP_lshr_U ("ACMP_lshr_U") {
        ACMP_lshr_U.clk(clk);
