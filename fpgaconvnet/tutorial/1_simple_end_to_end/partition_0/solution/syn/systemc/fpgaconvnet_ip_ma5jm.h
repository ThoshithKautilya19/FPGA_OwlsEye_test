...
// ==============================================================
#ifndef __fpgaconvnet_ip_ma5jm__HH__
#define __fpgaconvnet_ip_ma5jm__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_ma5jm) {
    ...
    SC_CTOR(fpgaconvnet_ip_ma5jm):  simcore_mac_0_U ("simcore_mac_0_U") {
