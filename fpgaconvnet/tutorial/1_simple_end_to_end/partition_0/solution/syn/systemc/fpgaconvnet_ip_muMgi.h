...
// ==============================================================
#ifndef __fpgaconvnet_ip_muMgi__HH__
#define __fpgaconvnet_ip_muMgi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_muMgi) {
    ...
    SC_CTOR(fpgaconvnet_ip_muMgi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
