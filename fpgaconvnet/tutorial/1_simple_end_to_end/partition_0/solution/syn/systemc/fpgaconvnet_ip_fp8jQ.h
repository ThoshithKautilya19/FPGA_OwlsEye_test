...
// ==============================================================
#ifndef __fpgaconvnet_ip_fp8jQ__HH__
#define __fpgaconvnet_ip_fp8jQ__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_fp8jQ) {
    ...
    SC_CTOR(fpgaconvnet_ip_fp8jQ):  ACMP_fpext_U ("ACMP_fpext_U") {
