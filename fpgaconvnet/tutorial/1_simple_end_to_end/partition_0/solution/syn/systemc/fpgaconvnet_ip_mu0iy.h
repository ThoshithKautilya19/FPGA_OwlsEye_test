...
// ==============================================================
#ifndef __fpgaconvnet_ip_mu0iy__HH__
#define __fpgaconvnet_ip_mu0iy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_mu0iy) {
    ...
    SC_CTOR(fpgaconvnet_ip_mu0iy):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
