...
// ==============================================================
#ifndef __fpgaconvnet_ip_si7jG__HH__
#define __fpgaconvnet_ip_si7jG__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(fpgaconvnet_ip_si7jG) {
    ...
    SC_CTOR(fpgaconvnet_ip_si7jG):  ACMP_sitodp_U ("ACMP_sitodp_U") {
