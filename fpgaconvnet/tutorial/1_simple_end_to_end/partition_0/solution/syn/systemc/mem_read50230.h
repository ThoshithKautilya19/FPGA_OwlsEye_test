...
#ifndef _mem_read50230_HH_
#define _mem_read50230_HH_
...
struct mem_read50230 : public sc_module {
    ...
    sc_out< sc_lv<16> > in_0_V_V_din;
    sc_in< sc_logic > in_0_V_V_full_n;
    sc_out< sc_logic > in_0_V_V_write;
    sc_in< sc_lv<32> > weights_reloading_in_2;
    sc_out< sc_lv<32> > weights_reloading_in_3_din;
    sc_in< sc_logic > weights_reloading_in_3_full_n;
    sc_out< sc_logic > weights_reloading_in_3_write;
    sc_in< sc_lv<29> > out_hw_V_offset;
    sc_out< sc_lv<29> > out_hw_V_offset_out_din;
    sc_in< sc_logic > out_hw_V_offset_out_full_n;
    sc_out< sc_logic > out_hw_V_offset_out_write;


    // Module declarations
    mem_read50230(sc_module_name name);
    SC_HAS_PROCESS(mem_read50230);
    ...
    sc_signal< sc_logic > in_hw_V_blk_n_AR;
    sc_signal< sc_logic > in_hw_V_blk_n_R;
    sc_signal< sc_logic > ap_CS_fsm_pp0_stage0;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< bool > ap_block_pp0_stage0;
    sc_signal< sc_lv<1> > icmp_ln59_reg_179;
    sc_signal< sc_logic > in_0_V_V_blk_n;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<1> > icmp_ln59_reg_179_pp0_iter1_reg;
    sc_signal< sc_logic > weights_reloading_in_3_blk_n;
    sc_signal< sc_logic > out_hw_V_offset_out_blk_n;
    sc_signal< sc_lv<10> > size_index_0_i_i_i_i_reg_135;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<1> > icmp_ln59_fu_157_p2;
    ...
    sc_signal< sc_lv<10> > size_index_fu_163_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<16> > p_Result_s_fu_169_p1;
    sc_signal< sc_lv<16> > p_Result_s_reg_188;
    sc_signal< sc_logic > ap_CS_fsm_state7;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_logic > ap_condition_pp0_exit_iter0_state8;
    sc_signal< sc_lv<64> > zext_ln327_fu_146_p1;
    ...
    void thread_icmp_ln59_fu_157_p2();
    void thread_in_0_V_V_blk_n();
    void thread_in_0_V_V_din();
    void thread_in_0_V_V_write();
    void thread_in_hw_V_blk_n_AR();
    void thread_in_hw_V_blk_n_R();
    ...
    void thread_out_hw_V_offset_out_blk_n();
    void thread_out_hw_V_offset_out_din();
    void thread_out_hw_V_offset_out_write();
    void thread_p_Result_s_fu_169_p1();
    void thread_real_start();
    void thread_size_index_fu_163_p2();
    void thread_start_out();
    void thread_start_write();
    void thread_weights_reloading_in_3_blk_n();
    void thread_weights_reloading_in_3_din();
    void thread_weights_reloading_in_3_write();
    void thread_zext_ln327_fu_146_p1();
