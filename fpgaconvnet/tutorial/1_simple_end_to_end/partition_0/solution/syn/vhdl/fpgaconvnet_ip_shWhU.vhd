...
entity fpgaconvnet_ip_shWhU is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 131;  --data bitwidth
      din1_WIDTH : INTEGER := 131;    --shift control bitwidth
      dout_WIDTH : INTEGER := 131;  --output bitwidth
...
end entity fpgaconvnet_ip_shWhU;
architecture rtl of fpgaconvnet_ip_shWhU is
