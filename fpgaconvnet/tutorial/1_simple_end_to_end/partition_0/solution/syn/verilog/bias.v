...
wire   [1:0] Conv_0_biases_V_0_address0;
reg    Conv_0_biases_V_0_ce0;
wire   [23:0] Conv_0_biases_V_0_q0;
reg    in_V_V_blk_n;
...
reg   [15:0] tmp_V_754_reg_235;
reg  signed [23:0] p_Val2_127_reg_240;
reg   [0:0] tmp_402_reg_245;
reg   [0:0] tmp_402_reg_245_pp0_iter2_reg;
reg   [15:0] p_Val2_129_reg_250;
...
wire  signed [23:0] tmp_402_fu_182_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_402_reg_245 <= tmp_402_fu_182_p1[32'd16];
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        p_Val2_129_reg_250 <= {{ret_V_fu_200_p2[32:17]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        Conv_0_biases_V_0_ce0 = 1'b1;
    end else begin
        Conv_0_biases_V_0_ce0 = 1'b0;
    end
end
...
assign Conv_0_biases_V_0_address0 = zext_ln61_fu_148_p1;
...
assign lhs_V_fu_190_p3 = {{tmp_V_754_reg_235}, {17'd0}};

assign out_V_V_din = (zext_ln415_fu_171_p1 + p_Val2_129_reg_250);

assign ret_V_fu_200_p2 = ($signed(sext_ln703_fu_197_p1) + $signed(lhs_V_fu_190_p3));

assign sext_ln703_fu_197_p1 = p_Val2_127_reg_240;

assign tmp_402_fu_182_p1 = Conv_0_biases_V_0_q0;

assign zext_ln415_fu_171_p1 = tmp_402_reg_245_pp0_iter2_reg;
