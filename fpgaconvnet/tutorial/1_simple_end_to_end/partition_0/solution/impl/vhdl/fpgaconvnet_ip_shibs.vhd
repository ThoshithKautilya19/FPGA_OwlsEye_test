...
entity fpgaconvnet_ip_shibs is
    generic (
      ID : INTEGER := 1;            --core ID, unused in RTL
      din0_WIDTH : INTEGER := 121;  --data bitwidth
      din1_WIDTH : INTEGER := 121;    --shift control bitwidth
      dout_WIDTH : INTEGER := 121;  --output bitwidth
...
end entity fpgaconvnet_ip_shibs;
architecture rtl of fpgaconvnet_ip_shibs is
