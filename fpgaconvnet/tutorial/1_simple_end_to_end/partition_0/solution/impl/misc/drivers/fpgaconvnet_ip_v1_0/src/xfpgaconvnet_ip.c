...
void XFpgaconvnet_ip_Set_fpgaconvnet_wr_0_V(XFpgaconvnet_ip *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFpgaconvnet_ip_WriteReg(InstancePtr->Ctrl_BaseAddress, XFPGACONVNET_IP_CTRL_ADDR_FPGACONVNET_WR_0_V_DATA, Data);
}

u32 XFpgaconvnet_ip_Get_fpgaconvnet_wr_0_V(XFpgaconvnet_ip *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFpgaconvnet_ip_ReadReg(InstancePtr->Ctrl_BaseAddress, XFPGACONVNET_IP_CTRL_ADDR_FPGACONVNET_WR_0_V_DATA);
    return Data;
}

void XFpgaconvnet_ip_Set_fpgaconvnet_in_0_V(XFpgaconvnet_ip *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFpgaconvnet_ip_WriteReg(InstancePtr->Ctrl_BaseAddress, XFPGACONVNET_IP_CTRL_ADDR_FPGACONVNET_IN_0_V_DATA, Data);
}

u32 XFpgaconvnet_ip_Get_fpgaconvnet_in_0_V(XFpgaconvnet_ip *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFpgaconvnet_ip_ReadReg(InstancePtr->Ctrl_BaseAddress, XFPGACONVNET_IP_CTRL_ADDR_FPGACONVNET_IN_0_V_DATA);
    return Data;
}

void XFpgaconvnet_ip_Set_fpgaconvnet_out_0_V(XFpgaconvnet_ip *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFpgaconvnet_ip_WriteReg(InstancePtr->Ctrl_BaseAddress, XFPGACONVNET_IP_CTRL_ADDR_FPGACONVNET_OUT_0_V_DATA, Data);
}

u32 XFpgaconvnet_ip_Get_fpgaconvnet_out_0_V(XFpgaconvnet_ip *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFpgaconvnet_ip_ReadReg(InstancePtr->Ctrl_BaseAddress, XFPGACONVNET_IP_CTRL_ADDR_FPGACONVNET_OUT_0_V_DATA);
    return Data;
}
