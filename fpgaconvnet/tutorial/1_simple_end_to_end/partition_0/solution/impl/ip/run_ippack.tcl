...
set Library     "hls"
set IPName      "fpgaconvnet_ip"
set Version     "1.0"
set DisplayName "Fpgaconvnet_ip"
set Revision    "1900000000"
...
set sdx_kernel_name "fpgaconvnet_ip"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/root/fpgaconvnet-tutorial/tutorial/1_simple_end_to_end/partition_0/solution"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {fifo_w16_d256_A
...
## Variables
set Top "fpgaconvnet_ip"
set TopNoPrefix "fpgaconvnet_ip"
...
set Interfaces {
    s_axi_ctrl {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 Data signal of mode"}}} {0x18 weights_reloading_index W 0x0 "Data signal of weights_reloading_index" {{0 32 weights_reloading_index W 0 "Bit 31 to 0 Data signal of weights_reloading_index"}}} {0x20 fpgaconvnet_wr_0_V W 0x0 "Data signal of fpgaconvnet_wr_0_V" {{0 32 fpgaconvnet_wr_0_V W 0 "Bit 31 to 0 Data signal of fpgaconvnet_wr_0_V"}}} {0x28 fpgaconvnet_in_0_V W 0x0 "Data signal of fpgaconvnet_in_0_V" {{0 32 fpgaconvnet_in_0_V W 0 "Bit 31 to 0 Data signal of fpgaconvnet_in_0_V"}}} {0x30 fpgaconvnet_out_0_V W 0x0 "Data signal of fpgaconvnet_out_0_V" {{0 32 fpgaconvnet_out_0_V W 0 "Bit 31 to 0 Data signal of fpgaconvnet_out_0_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl m_axi_fpgaconvnet_port_wr m_axi_fpgaconvnet_port_in m_axi_fpgaconvnet_port_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_fpgaconvnet_port_wr {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_fpgaconvnet_port_wr"
        data_width "64"
        param_prefix "C_M_AXI_FPGACONVNET_PORT_WR"
    ...
    m_axi_fpgaconvnet_port_in {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_fpgaconvnet_port_in"
        data_width "64"
        param_prefix "C_M_AXI_FPGACONVNET_PORT_IN"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 64 WSTRB 8 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 64 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_fpgaconvnet_port_out {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_fpgaconvnet_port_out"
        data_width "64"
        param_prefix "C_M_AXI_FPGACONVNET_PORT_OUT"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 64 WSTRB 8 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 64 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
