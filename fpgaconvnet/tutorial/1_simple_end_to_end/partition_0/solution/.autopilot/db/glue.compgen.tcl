...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_0_V_V_dout { I 30 vector } in_0_V_V_empty_n { I 1 bit } in_0_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_1_V_V_dout { I 30 vector } in_1_V_V_empty_n { I 1 bit } in_1_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_2_V_V_dout { I 30 vector } in_2_V_V_empty_n { I 1 bit } in_2_V_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_3_V_V_dout { I 30 vector } in_3_V_V_empty_n { I 1 bit } in_3_V_V_read { O 1 bit } } \
} "
}
