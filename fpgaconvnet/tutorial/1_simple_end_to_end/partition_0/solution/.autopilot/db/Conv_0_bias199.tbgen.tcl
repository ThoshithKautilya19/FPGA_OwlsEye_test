...
set C_modelName {Conv_0_bias199}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_bias_fu_28"}],
		"Port" : [
			{"Name" : "in_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_bias_fu_28", "Port" : "in_V_V"}]},
			{"Name" : "out_V_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_bias_fu_28", "Port" : "out_V_V"}]},
			{"Name" : "Conv_0_biases_V_0", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_bias_fu_28", "Port" : "Conv_0_biases_V_0"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_bias_fu_28", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "bias",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "Conv_0_biases_V_0", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_bias_fu_28.Conv_0_biases_V_0_U", "Parent" : "1"}]}
...
set ArgLastReadFirstWriteLatency {
	Conv_0_bias199 {
		...
		Conv_0_biases_V_0 {Type I LastRead -1 FirstWrite -1}}
	bias {
		in_V_V {Type I LastRead 2 FirstWrite -1}
		out_V_V {Type O LastRead -1 FirstWrite 4}
		Conv_0_biases_V_0 {Type I LastRead -1 FirstWrite -1}}}
