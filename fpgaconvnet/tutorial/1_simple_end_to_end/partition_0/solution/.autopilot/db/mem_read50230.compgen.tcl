...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_hw_V_offset { I 29 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_0_V_V_din { O 16 vector } in_0_V_V_full_n { I 1 bit } in_0_V_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { weights_reloading_in_2 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { weights_reloading_in_3_din { O 32 vector } weights_reloading_in_3_full_n { I 1 bit } weights_reloading_in_3_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_hw_V_offset { I 29 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 215 \
    name out_hw_V_offset_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_out_hw_V_offset_out \
    op interface \
    ports { out_hw_V_offset_out_din { O 29 vector } out_hw_V_offset_out_full_n { I 1 bit } out_hw_V_offset_out_write { O 1 bit } } \
} "
}
