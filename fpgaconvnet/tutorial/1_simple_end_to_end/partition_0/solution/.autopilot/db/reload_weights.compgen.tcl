...
# FIFO definition:
set ID 106
set FifoName start_for_weightsbkb
set InstName start_for_weightsbkb_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { wr_hw_V_offset { I 29 vector } wr_hw_V_offset_ap_vld { I 1 bit } } \
} "
}
